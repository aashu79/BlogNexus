...
<section class="categories-section">
	<div class="container">
		<div class="section-header">
			...
			<p class="section-subtitle">Discover content tailored to your
				interests or explore new topics.</p>
		</div>

		<div class="categories-grid">
			<a href="${pageContext.request.contextPath}/category?cat=technology"
				class="category-card">
				...
				href="${pageContext.request.contextPath}/category?cat=environment"
				class="category-card">
				<div class="category-icon">
			...
			</a> <a href="${pageContext.request.contextPath}/category?cat=food"
				class="category-card">
				<div class="category-icon">
			...
			</a> <a href="${pageContext.request.contextPath}/category?cat=travel"
				class="category-card">
				<div class="category-icon">
