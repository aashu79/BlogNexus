		...
		<div class="footer-content">
			...
			<div class="footer-primary">
				<div class="footer-column brand-column">
					...
					<div class="footer-logo">
						<a href="${contextPath}/" class="logo-link"> <span
							class="logo-text">BlogNexus</span>
						</a>
					</div>
					<p class="footer-tagline">Share your stories with the world</p>
					<p class="footer-description">BlogNexus is a modern platform
						for writers, thinkers, and creators to share ideas and connect
						with readers around the globe.</p>
					<div class="social-links">
						<a href="#" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
						<a href="#" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
						<a href="#" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
						<a href="#" aria-label="Pinterest"><i
							class="fab fa-pinterest-p"></i></a> <a href="#" aria-label="LinkedIn"><i
				...
				<div class="footer-column">
					...
					<ul class="footer-links">
						...
						<li><a href="${contextPath}/writers-guidelines">Writer's
								Guidelines</a></li>
					</ul>
				</div>
				...
				<div class="footer-column">
					...
					<ul class="footer-links">
						...
						<li><a href="${contextPath}/privacy-policy">Privacy
								Policy</a></li>
						<li><a href="${contextPath}/terms-and-condition">Terms of
								Service</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="footer-bottom">
				...
				<div class="footer-legal">
					<a href="${contextPath}/privacy-policy">Privacy Policy</a> <a
						href="${contextPath}/terms-and-condition">Terms of Use</a>

				</div>
				<div class="footer-credit">
					<p>
						Made with <i class="fas fa-heart"></i> by <a
							href="${contextPath}/about">BlogNexus Team</a>
					</p>
				</div>
			</div>
		</div>
