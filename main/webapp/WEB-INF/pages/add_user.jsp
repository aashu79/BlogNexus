...
<link rel="stylesheet"
	href="${contextPath}/css/add_user.css?v=<%=System.currentTimeMillis()%>">
</head>
<body>
	...
	<div class="content">
		...
		<div class="simple-card">
			<form action="${contextPath}/admin/users/add" method="post"
				...
				<div class="form-grid">
						...
						<div class="form-group">
							...
							<div class="select-field">
								<select id="role" name="role" required>
									...
									<option value="general">Regular User</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div class="form-column">
						...
						<div class="form-group">
							...
							<div class="input-field">
								<i class="fa-solid fa-phone"></i> <input type="tel" id="phone"
				...
				<div class="form-actions">
					<button type="button" class="cancel-btn"
						onclick="window.location.href='${contextPath}/admin/users'">
						Cancel</button>
