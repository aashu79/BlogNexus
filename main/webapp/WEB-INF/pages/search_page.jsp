...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/search_page.css">
</head>
<body>
    ...
    <div class="search-container">
        <header class="search-header">
            ...
            <form class="search-form" action="${pageContext.request.contextPath}/search" method="get">
                <input type="text" name="query" value="${searchQuery}" placeholder="Search blogs..." required>
                ...
                <c:when test="${empty searchResults}">
                    <div class="no-results-message">
                        ...
                        <div class="suggestion-links">
                            <a href="${pageContext.request.contextPath}/" class="btn btn-outline">Home</a>
                            <a href="${pageContext.request.contextPath}/user/blog/create" class="btn btn-primary">Create Blog</a>
                        </div>
                    </div>
                </c:when>
                <c:otherwise>
