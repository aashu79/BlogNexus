...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/blog_creation.css">
</head>
<body>
	...
	<div class="blog-container">
		...
		<form action="${pageContext.request.contextPath}/user/blog/create"
			...
			<div class="form-group">
				<label for="thumbnail">Upload Thumbnail Image</label> <input
					type="file" id="thumbnail" name="thumbnail" accept="image/*"
					required> <small class="form-text">Max file size:
					5MB</small>
			</div>

			<div class="form-group">
				<label for="image">Upload Featured Image</label> <input type="file"
					id="image" name="image" accept="image/*" required> <small
					class="form-text">Max file size: 5MB</small>
			</div>
