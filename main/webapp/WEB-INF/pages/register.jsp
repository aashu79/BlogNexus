...
<body>
		...
		<div class="visual-section">
			...
			<div class="illustration">
				...
				<div class="deco-element food">
					<svg viewBox="0 0 24 24" fill="none"
                        ...
                        <path
							...
							stroke="#8CBD9D" stroke-width="2" stroke-linecap="round" />
                        <path
							d="M5 10H19C20.1046 10 21 10.8954 21 12V13C21 14.1046 20.1046 15 19 15H5C3.89543 15 3 14.1046 3 13V12C3 10.8954 3.89543 10 5 10Z"
							stroke="#8CBD9D" stroke-width="2" stroke-linecap="round" />
                        <path d="M16 10V3M8 10V3" stroke="#8CBD9D"
							stroke-width="2" stroke-linecap="round" />
                    </svg>
				</div>
				...
				<div class="tagline">
					...
					<p>Join thousands of writers and creators who share their
						passion through words</p>
				</div>
			</div>
			<div class="quote">
						...
						<div class="form-column">
							...
							<div class="form-field">
								<div class="input-with-icon">
									<input type="tel" id="phone" name="phone"
										placeholder="Phone Number (Optional)"> <i
							...
							<div class="form-field password-field">
								<div class="input-with-icon">
									...
									<i class="fa-solid fa-lock"></i> <span class="toggle-password"
										id="confirmPasswordToggle" tabindex="0"> <i
										class="fa-regular fa-eye"></i>
									</span>
								</div>
							</div>
	...
	<script>
		...
		document.getElementById('confirmPasswordToggle').addEventListener(
				'click',
				function() {
