			...
			<div class="profile-header">
				<div class="profile-info">
					...
					<div class="profile-text">
						<h1 class="profile-name">${sessionScope.user.firstName}
				...
				<div class="profile-actions">
					<a href="${contextPath}/user/profile/update"
						class="btn btn-primary"> <i class="fas fa-pen"></i> Edit
						Profile
					</a>
				</div>
			</div>
					...
					<c:choose>
						<c:when test="${empty userBlogs}">
							<div class="no-blogs-message"
								...
								<p>You haven't published any blogs yet. Click "New Blog" to
							...
							<c:forEach items="${userBlogs}" var="blog">
								...
								<div class="blog-card">
									...
									<div class="blog-content">
										...
										<p class="blog-excerpt">${fn:substring(blog.content, 0, 150)}${fn:length(blog.content) > 150 ? '...' : ''}
										</p>
										<div class="blog-footer">
											<div class="blog-meta">
												<span class="blog-date"><i class="far fa-calendar"></i>
													2025-05-01 17:35:28</span> <span class="blog-status published">Published</span>
											</div>
											<div class="blog-actions">
												<a href="${contextPath}/user/blog/edit/${blog.blogId}"
													class="btn btn-sm btn-outline" title="Edit Blog"> <i
													class="fas fa-edit"></i> Edit
												</a>
												<form method="post" action="${contextPath}/user/blog/delete"
