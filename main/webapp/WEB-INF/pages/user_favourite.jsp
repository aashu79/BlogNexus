...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/user_favourite.css">
				...
				<c:choose>
					<c:when test="${empty blogs}">
						<div class="no-favourites">
							...
							<p>Browse our blogs and click the "Add to Favorites" button
								on blogs you love!</p>
							<a href="${pageContext.request.contextPath}/blogs"
								class="browse-btn">Browse Blogs</a>
						</div>
					</c:when>
					<c:otherwise>
						<c:forEach items="${blogs}" var="blog">
							...
							<div class="favourite-card">
								...
								<div class="card-content">
									...
									<h3 class="card-title">
										<a
											href="${pageContext.request.contextPath}/blog/${blog.blogId}">${blog.title}</a>
									</h3>
									...
									<div class="card-author">
										<div class="author-info">
											<span class="author-name">${blog.authorName}</span> <span
												class="author-role">${authorRoles[blog.blogId]}</span>
										</div>
									</div>

									<div class="card-actions">
										<a
											href="${pageContext.request.contextPath}/blog/${blog.blogId}"
											class="read-btn"> <i class="fas fa-book-open"></i> Read
											More
										</a>

										<form
											action="${pageContext.request.contextPath}/user/favourite/remove"
											method="post" class="remove-form">
											<input type="hidden" name="blogId" value="${blog.blogId}">
											<button type="submit" class="remove-btn"
												onclick="return confirm('Remove this blog from your favorites?')">
