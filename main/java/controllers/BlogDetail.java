...
public class BlogDetail extends HttpServlet {
	...
	/**
	 * Initializes the BlogDetail controller with BlogDetailService.
	 */
	public BlogDetail() {
		super();
	...
	/**
	 * Handles GET requests to display the blog detail page. Retrieves blog content,
	 * comments, and user-specific data for display.
	 * 
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("/blog/comment".equals(servletPath) || "/blog/favourite".equals(servletPath)
				|| "/blog/like".equals(servletPath)) {
	...
	/**
	 * Handles POST requests for comments, favourites, and likes. Delegates actions
	 * to BlogDetailService based on the request path.
	 * 
	 * @param request  The HTTP request object
	 * @param response The HTTP response object
	 * @throws ServletException If a servlet-specific error occurs
