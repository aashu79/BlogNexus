...
public class UserModel {
    ...
    public UserModel(String firstName, String lastName, String email, String phone, String country, String profilePicture, String userRole, String password) {
    ...
    public UserModel(int userId, String firstName, String lastName, String email, String phone, String country, String profilePicture, String userRole, String password) {
        this.userId = userId;
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
