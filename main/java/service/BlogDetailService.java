...
/**
 * Service class providing functionality for blog detail pages
 * including comments, favourites, and likes
 */
public class BlogDetailService {
    ...
    public String getAuthorProfilePictureUrl(int blogId) {
        ...
        String query = "SELECT u.profile_picture FROM blog b " +
                       "JOIN user u ON b.created_by = u.user_id " +
                       "WHERE b.blog_id = ?";
    ...
    public List<CommentModel> getCommentsByBlogId(int blogId) {
        ...
        String query = "SELECT c.*, u.first_name, u.last_name, u.profile_picture " +
                       "FROM comment c " +
    ...
    public void processCommentSubmission(HttpServletRequest req, HttpServletResponse res) {
        try {
            ...
            if (blogIdParam == null || commentContent == null || commentContent.trim().isEmpty()) {
                redirectionUtil.urlRedirectWithMessage(req, res, "/blog/" + blogIdParam, "error", "Comment cannot be empty");
                return;
            }
            ...
            if (success) {
                redirectionUtil.urlRedirectWithMessage(req, res, "/blog/" + blogId, "success", "Comment added successfully");
            } else {
