...
public class ProfileUpdatingService {
	...
	public void updateProfile(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		if (isChangingPassword) {
			...
			ValidationResult passwordResult = validatePasswordChange(currentPassword, newPassword, confirmPassword,
					userId);
	 ...
	 * @return ValidationResult with success status and message
	 */
	private ValidationResult validatePasswordChange(String currentPassword, String newPassword, String confirmPassword,
			int userId) {
	 ...
	 */
	private void updateUserInfo(int userId, String firstName, String lastName, String email, String phone,
			String country, String profilePicture) throws SQLException {
