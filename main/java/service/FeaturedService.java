...
public class FeaturedService {
    ...
    /**
     * Retrieves featured blogs with author details.
     * This method selects the most viewed or explicitly featured blogs.
     * 
    ...
    public Map<String, Object> getFeaturedBlogsWithAuthors(int count) {
        ...
        // Query to get featured blogs with author information
        // This assumes there's some way to determine "featured" status
        // You might need to adapt this query based on your database structure
        
        // Option 1: If you have a "featured" column
        ...
        //              "WHERE b.featured = 1 ORDER BY b.created_at DESC LIMIT ?";
        
        // Option 2: Using popularity metrics like views or likes
        String query = "SELECT b.*, u.first_name, u.last_name, u.profile_picture, u.user_role, " +
