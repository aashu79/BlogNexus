...
//    }
    ...
    public String getCategoryDescription(String category) {
        ...
        descriptions.put("Travel", "Journey to fascinating destinations and discover travel tips from around the globe.");
        descriptions.put("Food", "Savor delicious recipes, cooking techniques, and culinary adventures.");
        descriptions.put("Health", "Learn about wellness practices, fitness advice, and maintaining a balanced lifestyle.");
