...
/**
 * Utility class for handling page redirections and message passing in web application.
 * Provides methods for page forwarding, URL redirection, and attaching messages to request/session.
 */
public class RedirectionUtil {
     ...
     * @param res HTTP response (unused but kept for method signature consistency)
    ...
    /**
     * Forwards request to specified page with an attached message.
     * Combines sendMessageData and redirect operations.
     * 
     * @param req HTTP request to forward
     * @param res HTTP response to forward
     * @param page Target page for redirection
     ...
     * @throws ServletException If forwarding fails due to a servlet error
     */
    public void redirectWithMessage(HttpServletRequest req, HttpServletResponse res, String page, 
    ...
    /**
     * Performs URL redirection with a message stored in the session.
     * Use this when redirecting to a different URL while preserving messages.
     * 
     * @param req HTTP request to get session from
     * @param res HTTP response for redirection
     * @param page Target page for redirection
